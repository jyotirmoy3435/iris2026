...
import TeamSection from '@/components/TeamSection/TeamSection'; // Relative import to your components directory
...
const TeamPage: React.FC = () => {
  ...
  const coreTeamMembers = [
    {
      ...
      social: { linkedin: 'https://www.linkedin.com/in/nawang-tsering-bodh/' },
    },
    {
      id: 2,
      name: 'Shubham Sharma',
      ...
      social: { linkedin: 'https://www.linkedin.com/in/shubham-sharma-iim-indore/' },
    },
  ];

  // Vertical Coordinators (Full List)
  const verticalCoordinators = [
    // Corporate Relations & Partnerships
    {
      ...
      social: { linkedin: 'https://linkedin.com/in/anirudhkumar' },
    },
    {
      id: 4,
      name: 'Prachi Ekhar',
      ...
      social: { linkedin: 'https://linkedin.com/in/prachiekhar' },
    },
    // Creatives & Designs
    {
      id: 5,
      ...
      social: { linkedin: 'https://linkedin.com/in/ruchitabhoj' },
    },
    {
      id: 6,
      name: 'Sayan Mandal',
      ...
      social: { linkedin: 'https://linkedin.com/in/sayanmandal' },
    },
    // Events & Guests
    {
      id: 7,
